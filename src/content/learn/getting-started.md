...
Use **Library → Add music folder…** in the title menu, or the same action in the Library sidebar. Oscine scans the folder, reads tags, and builds artwork thumbnails. You can add more than one folder.

A watcher keeps the library in step when you add or remove files outside the app. You can turn that off in Settings if you would rather rescan by hand.
