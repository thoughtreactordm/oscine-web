---
title: Curate
description: Playlists, favorites, Discover shelves, and the queue.
order: 3
section: App
---
...
Create a playlist, drop tracks in, reorder them. The same song can appear twice. Export to m3u8 when you need the list somewhere else.

**My Favorites** sits at the top of the rail. It is a view over songs you have hearted, not a playlist you can accidentally delete.

Star a playlist or an artist to pin them in the Quick Menu on Now Playing.
